...
public interface EntityDao<E, PK extends Serializable> {
    ...
    public List<E> selectList(String statementName, PageRequest query) throws DataAccessException;

    public Object selectOne(String statementName, PageRequest query) throws DataAccessException;

    public Object findOneBy(PageRequest query) throws DataAccessException;
