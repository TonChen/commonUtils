...
import com.genaral.concurrent.async.AsyncToken;
import com.genaral.concurrent.async.AsyncTokenFactory;
import com.genaral.concurrent.async.AsyncTokenUtils;
import com.genaral.concurrent.async.DefaultAsyncTokenFactory;
...
public class AsyncJavaMailSender implements InitializingBean, DisposableBean, BeanNameAware {
    ...
    public void afterPropertiesSet() throws Exception {
        if (executorService == null && sendMailThreadPoolSize > 0) {
            executorService = newFixedThreadPool(sendMailThreadPoolSize, new CustomizableThreadFactory(getClass().getSimpleName() + "-"));
